...
if (!isset($_SESSION['easy_game']) || $loadParam !== 'true') {
  $_SESSION['easy_game'] = [
...
if (isset($_POST['roll']) && !$game['gameOver']) {
  ...
  // Snakes and ladders
  $snakes = [16 => 6, 48 => 30, 79 => 19];
  $ladders = [3 => 22, 8 => 26, 20 => 38, 41 => 60, 50 => 72];
  ...
  <div class="game-container">
    <div class="main-board">
      ...
      <div class="board-wrapper">
        ...
        <!-- Draw lines for snakes and ladders using CSS -->
        <div class="snake-line" style="left: 175px; top: 175px; width: 4px; height: 200px; transform: rotate(45deg);"></div>
        <div class="snake-line" style="left: 375px; top: 75px; width: 4px; height: 200px; transform: rotate(45deg);"></div>
        <div class="snake-line" style="left: 425px; top: 25px; width: 4px; height: 300px; transform: rotate(45deg);"></div>
        
        <div class="ladder-line" style="left: 125px; top: 375px; width: 4px; height: 200px; transform: rotate(-45deg);"></div>
        <div class="ladder-line" style="left: 375px; top: 375px; width: 4px; height: 150px; transform: rotate(-45deg);"></div>
        <div class="ladder-line" style="left: 475px; top: 275px; width: 4px; height: 200px; transform: rotate(-45deg);"></div>
      </div>
